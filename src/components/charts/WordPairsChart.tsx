...
export const WordPairsChart: React.FC<WordPairsChartProps> = ({ data }) => {
  ...
  if (pairData.length === 0) {
    return (
      <div className="w-full h-96 bg-white dark:bg-stone-800 rounded-2xl shadow-lg border border-stone-200 dark:border-stone-700 p-6 flex items-center justify-center">
